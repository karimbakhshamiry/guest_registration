<?php 
	...
	if (isset($_POST['firstName']) && isset($_POST['lastName']) && isset($_POST['contact']) && isset($_POST['jobTitle']) && isset($_POST['workPlace'])) {
		...
		$link->query($sql);
		$message ="<p class='success'>Successfully added</p>";
	}
?>
...
<body>
    ...
    <div class="container main__container">
		...
		<form action="" method="POST">
			<input type="text" name="firstName" id="firstName" placeholder="Enter visitor's first name" required>
			<input type="text" name="lastName" id="lastName" placeholder="Enter visitor's last name" required>
			<input type="text" name="contact" id="contact" placeholder="WhatsApp number" pattern="[0]{1}[0-9]{9}" minlength="10" maxlength="10" required>
			<input type="text" name="jobTitle" id="jobTitle" placeholder="Enter visitor's job title" required>
			<input type="text" name="workPlace" id="workPlace" placeholder="Enter visitor's work place" required>
